...
md"
=====================================================================================
#### UDL\_20240619\_4\_1\_1\_[Composing\_Networks\_I\_With\_LUX.jl](https://colab.research.google.com/github/udlbook/udlbook/blob/main/Notebooks/Chap04/4_1_Composing_Networks.ipynb#scrollTo=HqzePCLOVQK7)
##### file: UDL\_20240619\_4\_1\_1\_ComposingNetworks\_I\_With\_LUX.jl
##### code: Julia 1.10.4/Pluto by *** PCM 2024/06/21 ***
...
---
##### 3. LUX-Network Model
3.1 Definition of LUX.jl Network linear $\_1\_3\_1\_3\_1$ Model with optional tanh-Activation
"

# ╔═╡ 69c565a6-2c88-40fa-9dcc-afa84cda4ad5
function linear_1_3_1_3_1_Model(xsData::Vector{Float32}, ysData::Vector{Float32}; activation::Function=tanh)
	#-------------------------------------------------------------------------------
	...
	linear_1_3_1_3_1_Model = 
		Chain(
			Dense(1 => 3, activation), Dense(3 => 1), 
			Dense(1 => 3, activation), Dense(3 => 1))
	#-------------------------------------------------------------------------------
	learningRate = 0.03f0 
	...
	trainState = Lux.Experimental.TrainState(rng, linear_1_3_1_3_1_Model, optimizer)
	#-------------------------------------------------------------------------------
	...
	myCorSq   = myCor^2
	Plots.scatter(xsData, ysData, label=L"Data Points", titlefontsize=9, title="Composed NN 1-3-1-3-1 LUX-Model with $activation - activation")
	...
	#-------------------------------------------------------------------------------
end # function linear_1_3_1_3_1_Model
