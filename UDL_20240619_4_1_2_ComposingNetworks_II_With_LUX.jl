...
# ╔═╡ a7fa9ab2-55ae-447d-abc9-9a5210a09a8b
begin
	#-------------------------------------------------------------------------
	# Neural Nets
	...
	using Statistics
	#-------------------------------------------------------------------------
	using  Logistics, SpecialFunctions
	#-------------------------------------------------------------------------
	# LateXify Strings
...
# ╔═╡ 4a9d6e70-2e1f-11ef-129d-a3ac8e3f8d85
md"
=====================================================================================
#### UDL\_20240619\_4\_1\_2\_[Composing\_Networks\_II\_With\_LUX.jl](https://colab.research.google.com/github/udlbook/udlbook/blob/main/Notebooks/Chap04/4_1_Composing_Networks.ipynb#scrollTo=HqzePCLOVQK7)
##### file: UDL\_20240619\_4\_1\_2\_ComposingNetworks\_II\_With\_LUX.jl
##### code: Julia 1.10.4/Pluto by *** PCM 2024/06/22 ***
...
# ╔═╡ 80871495-6a3a-4b8d-a60b-5a268869b7b1
md"
##### 0. Introduction
First we *generate* data $ys$ with a *composed* network. Then we demonstrate that these data can be reproduced by *deep* network which is a shrinked version of two composed networks. That is a network where the output unit of the first and the input unit of the second network are deleted.
"

# ╔═╡ 8623f702-6107-406b-ad14-0972ee393e57
md"
---
##### 1. Packages
"

# ╔═╡ 80849a0b-dafd-4ed4-b82a-f7f1f328f751
md"
---
##### 2. Generator Network $shallow\_1\_3\_1$
###### 2.1 Specification
"

# ╔═╡ fa06bed0-ebb7-4b8b-a2ab-de988d464a29
...
# ╔═╡ 7ccda237-0e95-4d3e-81b2-fa6743c5b2f2
md"
---
###### 2.2 Parameters
(obtained from [Prince, 2024](https://colab.research.google.com/github/udlbook/udlbook/blob/main/Notebooks/Chap04/4_1_Composing_Networks.ipynb#scrollTo=JRebvurv22pT))
"

# ╔═╡ f67200c2-5c51-496b-83ab-73c348a60952
begin                           # number of parameters = 10
	#-------------------------------------------------------------------------------
	n1_θ10 =  0.00f0 ; n1_θ11 = -1.0f0
	n1_θ20 =  0.00f0 ; n1_θ21 =  1.0f0 
	n1_θ30 = -0.67f0 ; n1_θ31 =  1.0f0
	n1_ϕ0  =  1.00f0 ; n1_ϕ1  = -2.0f0 
	n1_ϕ2  = -3.00f0 ; n1_ϕ3  =  9.3f0
	#-------------------------------------------------------------------------------
	n2_θ10 = -0.60f0 ; n2_θ11 = -1.0f0
	n2_θ20 =  0.20f0 ; n2_θ21 =  1.0f0 
	n2_θ30 = -0.50f0 ; n2_θ31 =  1.0f0
	n2_ϕ0  =  0.50f0 ; n2_ϕ1  = -1.0f0 
	n2_ϕ2  = -1.50f0 ; n2_ϕ3  =  2.0f0
	#-------------------------------------------------------------------------------
end # begin

# ╔═╡ 0017d824-65ac-4546-a918-94826b9e82ce
md"
---
###### 2.3 Generators' In- and Output

The neural nets are used as a data generators. A training set $xs$ is used as input and propagated through the *first* network to generate the numeric vector output of net 1 $n1_ys$. Then this is used as input to the *second* network to generate the final ouput $n2_ys$.
"

# ╔═╡ 7248d3bb-8f33-483c-965b-f89e434b1236
md"
###### 2.3.1 Generation of Input (= Predictor Subspace)
"

# ╔═╡ 0c10a8f5-a4b7-49ec-9714-9ecec51ba033
begin
	# generation of input data xs for the neural network generator
	xs = convert(Vector{Float32}, [x for x in -1.0:0.02:1.0])
	const N = length(xs)
end # begin

# ╔═╡ 72c55a65-7948-4952-8331-b9d0f670e0a5
md"
---
###### 2.3.2 Generators Outputs
(cf. [Prince, 2024, Fig. 4.1, p.42](https://udlbook.github.io/udlbook/))
"

# ╔═╡ f91fba47-692c-4ebe-ac3f-7c3b553109aa
# generation of output with first shallow 1-3-1 neural network (= NN1)
n1_ys, rest1... = 
	shallow_1_3_1(xs, relu, n1_ϕ0, n1_ϕ1, n1_ϕ2, n1_ϕ3, n1_θ10, n1_θ11, n1_θ20, n1_θ21, n1_θ30, n1_θ31)

# ╔═╡ bbecf91b-6ee2-46c2-a723-436a77235fce
# generation of output with second shallow 1-3-1 neural network (= NN2)
ys, rest2... = 
	shallow_1_3_1(n1_ys, relu, n2_ϕ0, n2_ϕ1, n2_ϕ2, n2_ϕ3, n2_θ10, n2_θ11, n2_θ20, n2_θ21, n2_θ30, n2_θ31)

# ╔═╡ ea050477-ef5c-46c1-abf9-d8eddf324281
let plot1 = 
		scatter(xs, n1_ys, color=:green, label=L"n1\_ys", xlabel=L"xs\ (NN1\ input)", ylabel=L"n1\_ys\ (NN1\ output)", title="plot1: Network NN1", titlefontsize=10)
	plot2 = 
		scatter(n1_ys, ys, label=L"ys", xlabel=L"n1\_ys\ (NN1\ output)", ylabel=L"ys\ (NN2\ output)", title="plot2: Network NN2", titlefontsize=10)
	plot(plot1, plot2, layout=grid(1, 2))
end # let

# ╔═╡ bd4ff042-9d38-4104-af4b-ab0ca87f14ac
let plot3 = 
		scatter(xs, ys, label=L"n2\_ys", xlabel=L"xs\ (NN1\ input)", ylabel=L"ys\ (NN2\ output)", title="plot3: Composed Network NN1 & NN2", titlefontsize=10)
		plot!([0.0, 0.0],     [-0.55, -0.3],  linestyle=:dot, lw=2, label=L"1.NN2")
		plot!([0.662, 0.662], [-0.55,  0.12], linestyle=:dot, lw=2, label=L"2.NN2")
		plot!([1.0, 1.0],     [-0.55, -0.26], linestyle=:dot, lw=2, label=L"3.NN2")
	plot(plot3)
end # let

# ╔═╡ d21ec723-72b1-4410-b5bf-464b63c42bb5
md"
---
##### 3. Externalized LUX-Model Definition
###### 3.1 $linear\_1\_3\_1\_3\_1\_Model$
The LUX-model definition is now *externalized* and used as an *argument* in the *call* of the function $trainTheModel$.

"

# ╔═╡ 20bf7d45-5876-4259-9b20-533ea15e0e6e
#-------------------------------------------------------------------------------
linear_1_3_1_3_1_Model = 
	Chain(
		Dense(1 => 3, tanh), Dense(3 => 1), 
		Dense(1 => 3, tanh), Dense(3 => 1))

# ╔═╡ 69c565a6-2c88-40fa-9dcc-afa84cda4ad5
function trainTheModel(luxModel, xsData::Vector{Float32}, ysData::Vector{Float32}; activation::Function=tanh)
	#-------------------------------------------------------------------------------
	...
	myCorSq   = myCor^2
	Plots.scatter(xsData, ysData, label=L"Data Points", titlefontsize=9, title="LUX-Model with $activation - activation")
	Plots.scatter!(xsData, ysPredNew', label=L"Model Predictions", color=:red)
	annotate!(-0.72, -0.18, "mse = $mseLoss", 8)
	annotate!(-0.72, -0.24, "r(y, y-hat) = $myCor", 8)
	annotate!(-0.72, -0.30, "r(y, y-hat)^2 = $myCorSq", 8)
	annotate!(-0.72, -0.36, "#epochs = $epochs", 8)
	#-------------------------------------------------------------------------------
end # function trainTheModel

# ╔═╡ 21c4755f-a66b-46ff-b352-ecc4909b965e
md"
---
###### 3.2 Train the Model $linear\_1\_3\_1\_3\_1\_Model$
"

# ╔═╡ 8caf093d-73fc-4036-b7e3-628f7fdde293
trainTheModel(linear_1_3_1_3_1_Model, xs, ys)

# ╔═╡ 5a6f22c5-f730-49d1-9902-ebf88b4df7f6
md"
---
###### 3.3 Composition (= Deep) $linear\_1\_3\_3\_1\_Model$ 
"

# ╔═╡ c0840889-f88d-4334-86f2-2b9e4d9471ea
linear_1_3_3_1_Model = 
	Chain(
		Dense(1 => 3, tanh), 
		Dense(3 => 3, tanh), 
		Dense(3 => 1))

# ╔═╡ 01400f02-f39e-47c6-b1f4-41fc02d12548
md"
---
###### 3.4 Train the Composed (= Deep) Model $linear\_1\_3\_3\_1\_Model$ 

"

# ╔═╡ 4cf23370-e84d-4e9c-a8ff-05166c7ac4ee
trainTheModel(linear_1_3_3_1_Model, xs, ys)

# ╔═╡ 9b00de35-d68b-431d-b419-5fa351a08b84
md"
---
##### References
...
- **Prince, S.J.D.**; [*Understanding Deep Learning*](https://udlbook.github.io/udlbook/); MIT Press, 2024

- **Prince, S.J.D.**; [*Notebook 4.1 -- Composing networks*](https://github.com/udlbook/udlbook/blob/main/Notebooks/Chap04/4_1_Composing_Networks.ipynb); last visit 2024/06/19

"

# ╔═╡ 64fa72c2-e1a6-44a4-a114-966b1c22e7a7
md"
====================================================================================
